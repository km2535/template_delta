      ...
      <div className={styles.content}>
        ...
        <div className={styles.productInfoContainer}>
          ...
          <div className={styles.productInfoMain}>
            ...
            <div className={styles.btn}><Button main={true} text='상품구매'  onClick={buyProduct}/></div>
            <div className={styles.btn}><Button main={false} text='장바구니'  onClick={putInBocket}/></div>
          </div>
        </div>
      </div>
      <p className={styles.line}></p>
